...
const TenantManagement = () => {
  ...
  const fetchTenants = async () => {
    ...
    try {
      ...
      setMessage({
        type: "error",
        text: "Không thể tải danh sách khách thuê. Vui lòng kiểm tra quyền hạn!",
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="page-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          <p className="col-span-full text-center py-10 text-muted">
            Đang tải danh sách...
          </p>
            ...
            <div key={tenant.id} className="card hover-scale">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <span className={`badge badge-active`}>Khách đang thuê</span>
                </div>
              </div>
                ...
                <button
                  ...
                  onClick={() => {
                    if (tenant.email) {
                      ...
                      alert(
                        `Vui lòng liên hệ trực tiếp qua số điện thoại: ${tenant.phoneNumber}`,
                      );
                    }
                  }}
                >
